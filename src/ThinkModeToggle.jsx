...
export default function ThinkModeToggle({ enabled, onChange, disabled }) {
  return (
    <button
      type="button"
      role="checkbox"
      aria-checked={enabled}
      aria-label="Think mode — show reasoning before the answer"
      disabled={disabled}
    ...
    >
      <Sparkles className="h-3.5 w-3.5 shrink-0 opacity-75" aria-hidden />
